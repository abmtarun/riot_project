...
static ssize_t _riot_board_handler(coap_pkt_t* pdu, uint8_t *buf, size_t len, struct _coap_request_ctx *ctx);

static ssize_t _riot_cpu_handler(coap_pkt_t* pdu, uint8_t *buf, size_t len, struct _coap_request_ctx *ctx);

static ssize_t _temperature_handler(coap_pkt_t* pdu, uint8_t *buf, size_t len, struct _coap_request_ctx *ctx);

static ssize_t _value_handler(coap_pkt_t* pdu, uint8_t *buf, size_t len, struct _coap_request_ctx *ctx);
